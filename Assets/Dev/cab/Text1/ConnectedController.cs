...
public class ConnectedController : MonoBehaviour
{
    ...
    void GetConnections()
    {
        Connection c = new Connection (PlayerA, PlayerB, PlayerC);
        Connection c1 = new Connection (InteractorA, InteractorB, InteractorC);
        Connections.Add(c);
        Connections.Add(c1);
    }
    ...
    void CheckandChange()
    {
        foreach (var connection in Connections)
        {
            ...
            if (connection.TransformB.position != connection.PositionB)
            {
                ...
                {
                    Rigidbody rb1 = connection.TransformA.GetComponent<Rigidbody>();
                    Rigidbody rb2 = connection.TransformC.GetComponent<Rigidbody>();
                    ...
                    connection.PositionB=connection.TransformB.parent.parent.InverseTransformDirection(connection.TransformB.position);
                }
                else
                {
                ...
                connection.PositionB=connection.TransformB.parent.InverseTransformDirection(connection.TransformB.position);
            }
